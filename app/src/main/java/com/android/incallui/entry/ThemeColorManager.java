...
public class ThemeColorManager {
    ...
    private void updateThemeColors(Context context, @ColorInt int highlightColor, boolean isSpam) {
        ...
        if (isSpam) {
            ...
            backgroundColorTop = context.getColor(R.color.incall_background_gradient_spam_top_ext);
            backgroundColorMiddle = context.getColor(R.color.incall_background_gradient_spam_middle_ext);
            backgroundColorBottom = context.getColor(R.color.incall_background_gradient_spam_bottom_ext);
            backgroundColorSolid = context.getColor(R.color.incall_background_multiwindow_spam_ext);
        } else {
            palette = colorMap.calculatePrimaryAndSecondaryColor(highlightColor);
            backgroundColorTop = context.getColor(R.color.incall_background_gradient_top_ext);
            backgroundColorMiddle = context.getColor(R.color.incall_background_gradient_middle_ext);
            backgroundColorBottom = context.getColor(R.color.incall_background_gradient_bottom_ext);
            backgroundColorSolid = context.getColor(R.color.incall_background_multiwindow_ext);
