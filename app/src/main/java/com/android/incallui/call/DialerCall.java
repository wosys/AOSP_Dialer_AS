...
import com.wintmain.dialer.enrichedcall.EnrichedCallManager.Filter;
...
import com.wintmain.dialer.logging.ContactLookupResult.Type;
...
public class DialerCall implements VideoTechListener, StateChangedListener, CapabilitiesListener {
    ...
    private com.wintmain.dialer.logging.VideoTech.Type selectedAvailableVideoTechType =
            com.wintmain.dialer.logging.VideoTech.Type.NONE;
...
//        }
    ...
    public VideoTech getVideoTech() {
        if (videoTech == null) {
            ...
            if (selectedAvailableVideoTechType == com.wintmain.dialer.logging.VideoTech.Type.NONE) {
    ...
    public com.wintmain.dialer.logging.VideoTech.Type getSelectedAvailableVideoTechType() {
