 ...
 * </pre>
 * <p>
 * Protobuf type {@code com.wintmain.dialer.CoalescedIds}
 */
public final class CoalescedIds extends
        com.google.protobuf.GeneratedMessageLite<CoalescedIds, CoalescedIds.Builder> implements
        // @@protoc_insertion_point(message_implements:com.wintmain.dialer.CoalescedIds)
        CoalescedIdsOrBuilder {
    // public static final int COALESCED_ID_FIELD_NUMBER = 1;
    // @@protoc_insertion_point(class_scope:com.wintmain.dialer.CoalescedIds)
    private static final com.wintmain.dialer.CoalescedIds DEFAULT_INSTANCE;
    ...
    public static com.wintmain.dialer.CoalescedIds parseFrom(
    ...
    public static com.wintmain.dialer.CoalescedIds parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return com.google.protobuf.GeneratedMessageLite.parseFrom(
                DEFAULT_INSTANCE, data);
    }
    ...
    public static com.wintmain.dialer.CoalescedIds parseFrom(java.io.InputStream input)
    ...
    public static com.wintmain.dialer.CoalescedIds parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
        return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }

    public static com.wintmain.dialer.CoalescedIds parseDelimitedFrom(
            java.io.InputStream input,
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
    ...
    public static Builder newBuilder(com.wintmain.dialer.CoalescedIds prototype) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }

    public static com.wintmain.dialer.CoalescedIds getDefaultInstance() {
     ...
     */
    public java.util.List<java.lang.Long> getCoalescedIdList() {
        return coalescedId_;
    }
    ...
    private void ensureCoalescedIdIsMutable() {
        if (!coalescedId_.isModifiable()) {
            coalescedId_ = com.google.protobuf.GeneratedMessageLite.mutableCopy(coalescedId_);
        }
    }
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            case NEW_MUTABLE_INSTANCE: {
                return new com.wintmain.dialer.CoalescedIds();
            }
            case IS_INITIALIZED: {
                return DEFAULT_INSTANCE;
            }
            ...
            case VISIT: {
                ...
                com.wintmain.dialer.CoalescedIds other = (com.wintmain.dialer.CoalescedIds) arg1;
            ...
            case GET_PARSER: {
                if (PARSER == null) {
                    synchronized (com.wintmain.dialer.CoalescedIds.class) {
                        if (PARSER == null) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<com.wintmain.dialer.CoalescedIds, Builder> implements
            // @@protoc_insertion_point(builder_implements:com.wintmain.dialer.CoalescedIds)
            com.wintmain.dialer.CoalescedIdsOrBuilder {
        // Construct using com.wintmain.dialer.CoalescedIds.newBuilder()
        private Builder() {
        ...
        // @@protoc_insertion_point(builder_scope:com.wintmain.dialer.CoalescedIds)
    }
}
