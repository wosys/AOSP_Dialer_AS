...
public final class CallConfiguration
    ...
    public static com.wintmain.dialer.CallConfiguration parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return com.google.protobuf.GeneratedMessageLite.parseFrom(
                DEFAULT_INSTANCE, data);
    }
    ...
    public static com.wintmain.dialer.CallConfiguration parseDelimitedFrom(
            java.io.InputStream input,
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
    ...
    public static Builder newBuilder(com.wintmain.dialer.CallConfiguration prototype) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }

    public static com.wintmain.dialer.CallConfiguration getDefaultInstance() {
    ...
    public com.wintmain.dialer.Mode getCallMode() {
        ...
        return result == null ? com.wintmain.dialer.Mode.MODE_UNSPECIFIED : result;
    }
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            case NEW_MUTABLE_INSTANCE: {
                return new com.wintmain.dialer.CallConfiguration();
            }
            case IS_INITIALIZED: {
                return DEFAULT_INSTANCE;
            }
                    ...
                    while (!done) {
                        ...
                        switch (tag) {
                            ...
                            case 8: {
                                ...
                                com.wintmain.dialer.Mode value = com.wintmain.dialer.Mode.forNumber(rawValue);
                                if (value == null) {
            ...
            case GET_PARSER: {
                if (PARSER == null) {
                    synchronized (com.wintmain.dialer.CallConfiguration.class) {
                        if (PARSER == null) {
