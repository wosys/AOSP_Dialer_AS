...
public final class CoalescedRow extends
    ...
    private com.wintmain.dialer.DialerPhoneNumber number_;
    ...
    private com.wintmain.dialer.NumberAttributes numberAttributes_;
    private boolean isVoicemailCall_;
    private java.lang.String voicemailCallTag_;
    private com.wintmain.dialer.CoalescedIds coalescedIds_;
    ...
    public static com.wintmain.dialer.calllog.model.CoalescedRow parseFrom(
    ...
    public static com.wintmain.dialer.calllog.model.CoalescedRow parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return com.google.protobuf.GeneratedMessageLite.parseFrom(
                DEFAULT_INSTANCE, data);
    }
    ...
    public static com.wintmain.dialer.calllog.model.CoalescedRow parseFrom(java.io.InputStream input)
    ...
    public static com.wintmain.dialer.calllog.model.CoalescedRow parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
        return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }

    public static com.wintmain.dialer.calllog.model.CoalescedRow parseDelimitedFrom(
            java.io.InputStream input,
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
    ...
    public static Builder newBuilder(com.wintmain.dialer.calllog.model.CoalescedRow prototype) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }

    public static com.wintmain.dialer.calllog.model.CoalescedRow getDefaultInstance() {
    ...
    private void mergeNumber(com.wintmain.dialer.DialerPhoneNumber value) {
        if (number_ != null &&
                number_ != com.wintmain.dialer.DialerPhoneNumber.getDefaultInstance()) {
            number_ =
                    com.wintmain.dialer.DialerPhoneNumber.newBuilder(number_).mergeFrom(value).buildPartial();
        } else {
            number_ = value;
        }
        bitField0_ |= 0x00000004;
    ...
    private void mergeNumberAttributes(com.wintmain.dialer.NumberAttributes value) {
        if (numberAttributes_ != null &&
                numberAttributes_ != com.wintmain.dialer.NumberAttributes.getDefaultInstance()) {
            numberAttributes_ =
                    com.wintmain.dialer.NumberAttributes.newBuilder(numberAttributes_).mergeFrom(value).buildPartial();
        } else {
            numberAttributes_ = value;
        }
        bitField0_ |= 0x00001000;
    ...
    private void mergeCoalescedIds(com.wintmain.dialer.CoalescedIds value) {
        if (coalescedIds_ != null &&
                coalescedIds_ != com.wintmain.dialer.CoalescedIds.getDefaultInstance()) {
            coalescedIds_ =
                    com.wintmain.dialer.CoalescedIds.newBuilder(coalescedIds_).mergeFrom(value).buildPartial();
        } else {
            coalescedIds_ = value;
        }
        bitField0_ |= 0x00008000;
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            case NEW_MUTABLE_INSTANCE: {
                return new com.wintmain.dialer.calllog.model.CoalescedRow();
            }
            case IS_INITIALIZED: {
                return DEFAULT_INSTANCE;
            }
            ...
            case VISIT: {
                ...
                com.wintmain.dialer.calllog.model.CoalescedRow other = (com.wintmain.dialer.calllog.model.CoalescedRow) arg1;
                    ...
                    while (!done) {
                        ...
                        switch (tag) {
                            ...
                            case 26: {
                                ...
                                number_ = input.readMessage(com.wintmain.dialer.DialerPhoneNumber.parser(), extensionRegistry);
                                if (subBuilder != null) {
                            ...
                            case 106: {
                                com.wintmain.dialer.NumberAttributes.Builder subBuilder = null;
                                if (((bitField0_ & 0x00001000) == 0x00001000)) {
                                    subBuilder = numberAttributes_.toBuilder();
                                }
                                numberAttributes_ = input.readMessage(com.wintmain.dialer.NumberAttributes.parser(), extensionRegistry);
                                if (subBuilder != null) {
                            ...
                            case 130: {
                                com.wintmain.dialer.CoalescedIds.Builder subBuilder = null;
                                if (((bitField0_ & 0x00008000) == 0x00008000)) {
                                    subBuilder = coalescedIds_.toBuilder();
                                }
                                coalescedIds_ = input.readMessage(com.wintmain.dialer.CoalescedIds.parser(), extensionRegistry);
                                if (subBuilder != null) {
            ...
            case GET_PARSER: {
                if (PARSER == null) {
                    synchronized (com.wintmain.dialer.calllog.model.CoalescedRow.class) {
                        if (PARSER == null) {
