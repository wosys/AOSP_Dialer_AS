...
public final class PeopleApiLookupError extends
    ...
    private static final com.wintmain.dialer.logging.PeopleApiLookupError DEFAULT_INSTANCE;
    ...
    public static com.wintmain.dialer.logging.PeopleApiLookupError parseFrom(
    ...
    public static com.wintmain.dialer.logging.PeopleApiLookupError parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return com.google.protobuf.GeneratedMessageLite.parseFrom(
                DEFAULT_INSTANCE, data);
    }
    ...
    public static com.wintmain.dialer.logging.PeopleApiLookupError parseFrom(java.io.InputStream input)
    ...
    public static com.wintmain.dialer.logging.PeopleApiLookupError parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
        return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }

    public static com.wintmain.dialer.logging.PeopleApiLookupError parseDelimitedFrom(
            java.io.InputStream input,
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
    ...
    public static Builder newBuilder(com.wintmain.dialer.logging.PeopleApiLookupError prototype) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }

    public static com.wintmain.dialer.logging.PeopleApiLookupError getDefaultInstance() {
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            case NEW_MUTABLE_INSTANCE: {
                return new com.wintmain.dialer.logging.PeopleApiLookupError();
            }
            case IS_INITIALIZED: {
                return DEFAULT_INSTANCE;
            }
            ...
            case VISIT: {
                ...
                com.wintmain.dialer.logging.PeopleApiLookupError other = (com.wintmain.dialer.logging.PeopleApiLookupError) arg1;
                return this;
            }
            ...
            case GET_PARSER: {
                if (PARSER == null) {
                    synchronized (com.wintmain.dialer.logging.PeopleApiLookupError.class) {
                        if (PARSER == null) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<
                    com.wintmain.dialer.logging.PeopleApiLookupError, Builder> implements
            // @@protoc_insertion_point(builder_implements:com.fissy.dialer.logging.PeopleApiLookupError)
            com.wintmain.dialer.logging.PeopleApiLookupErrorOrBuilder {
